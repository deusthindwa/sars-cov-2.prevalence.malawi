...
spn_fup %>%
  mutate(stnew = if_else(sstate == 1L, NA_character_,
                         if_else(sstate == 2L, "7A/B/C",
                                 if_else(sstate == 3L, "15A/B/C/F",
                                         if_else(sstate == 4L, "3",
                                                 if_else(sstate == 5L, "11A/B/C/D/F",
                                                         if_else(sstate == 6L, "23A/B",
                                                                 if_else(sstate == 7L, "17A/F",
                                                                         if_else(sstate == 8L, "19F",
                                                                                 if_else(sstate == 9L, "10A/B/C/F",
                                                                                         if_else(sstate == 10L, "20",
                                                                                                 if_else(sstate == 11L, "6C",
                                                                                                         if_else(sstate == 12L, "9A/L/N",
                                                                                                                 if_else(sstate == 13L, "19A",
                                                                                                                         if_else(sstate == 14L, "6A",
                                                                                                                                 if_else(sstate == 15L, "oVT",
                                                                                                                                         if_else(sstate == 16L, "uNVT", "kNVT"))))))))))))))))) %>%
...
spn_wiw <- 
  as.data.frame(statetable.msm(sstate, pid, data = spn_fup)) %>% 
  mutate(Freq = Freq+1) %>%
  dplyr::rename("weight" = Freq) %>%
  filter(weight>1 & from != to & to != 1 & from !=1) %>%
  mutate(from = if_else(from == 2L, "7A/B/C",
                        if_else(from == 3L, "15A/B/C/F",
                                if_else(from == 4L, "3",
                                        if_else(from == 5L, "11A/B/C/D/F",
                                                if_else(from == 6L, "23A/B",
                                                        if_else(from == 7L, "17A/F",
                                                                if_else(from == 8L, "19F",
                                                                        if_else(from == 9L, "10A/B/C/F",
                                                                                if_else(from == 10L, "20",
                                                                                        if_else(from == 11L, "6C",
                                                                                                if_else(from == 12L, "9A/L/N",
                                                                                                        if_else(from == 13L, "19A",
                                                                                                                if_else(from == 14L, "6A",
                                                                                                                        if_else(from == 15L, "oVT",
                                                                                                                                if_else(from == 16L, "uNVT", "kNVT"))))))))))))))),
         to = if_else(to == 2L, "7A/B/C",
                      if_else(to == 3L, "15A/B/C/F",
                              if_else(to == 4L, "3",
                                      if_else(to == 5L, "11A/B/C/D/F",
                                              if_else(to == 6L, "23A/B",
                                                      if_else(to == 7L, "17A/F",
                                                              if_else(to == 8L, "19F",
                                                                      if_else(to == 9L, "10A/B/C/F",
                                                                              if_else(to == 10L, "20",
                                                                                      if_else(to == 11L, "6C",
                                                                                              if_else(to == 12L, "9A/L/N",
                                                                                                      if_else(to == 13L, "19A",
                                                                                                              if_else(to == 14L, "6A",
                                                                                                                      if_else(to == 15L, "oVT",
                                                                                                                              if_else(to == 16L, "uNVT", "kNVT")))))))))))))))) %>%
...
pneumo0 <- data.frame("serotype" = c("7A/B/C", "15A/B/C/F", "3", "11A/B/C/D/F", "23A/B", "17A/F", "19F", "10A/B/C/F", "20", "6C", "9A/L/N", "19A", "6A", "oVT", "uNVT", "kNVT"))
pneumo0$carry <- c(modela$estimates[1,2], modela$estimates[1,3], modela$estimates[1,4], modela$estimates[1,5], modela$estimates[1,6], modela$estimates[1,7], modela$estimates[1,8], modela$estimates[1,9], modela$estimates[1,10], modela$estimates[1,11], modela$estimates[1,12], modela$estimates[1,13], modela$estimates[1,14], modela$estimates[1,15], modela$estimates[1,16], modela$estimates[1,17])
pneumo0$Lcarry <- c(modela$L[1,2], modela$L[1,3], modela$L[1,4], modela$L[1,5], modela$L[1,6], modela$L[1,7], modela$L[1,8], modela$L[1,9], modela$L[1,10], modela$L[1,11], modela$L[1,12], modela$L[1,13], modela$L[1,14], modela$L[1,15], modela$L[1,16], modela$L[1,17]) 
pneumo0$Ucarry <- c(modela$U[1,2], modela$U[1,3], modela$U[1,4], modela$U[1,5], modela$U[1,6], modela$U[1,7], modela$U[1,8], modela$U[1,9], modela$U[1,10], modela$U[1,11], modela$U[1,12], modela$U[1,13], modela$U[1,14], modela$U[1,15], modela$U[1,16], modela$U[1,17]) 
...
pneumo1 <- data.frame("serotype" = c("7A/B/C", "15A/B/C/F", "3", "11A/B/C/D/F", "23A/B", "17A/F", "19F", "10A/B/C/F", "20", "6C", "9A/L/N", "19A", "6A", "oVT", "uNVT", "kNVT"))
pneumo1$clear <- c(modelb$estimates[2,1], modelb$estimates[3,1], modelb$estimates[4,1], modelb$estimates[5,1], modelb$estimates[6,1], modelb$estimates[7,1], modelb$estimates[8,1], modelb$estimates[9,1], modelb$estimates[10,1], modelb$estimates[11,1], modelb$estimates[12,1], modelb$estimates[13,1], modelb$estimates[14,1], modelb$estimates[15,1], modelb$estimates[16,1], modelb$estimates[17,1])
pneumo1$Lclear <- c(modelb$L[2,1], modelb$L[3,1], modelb$L[4,1], modelb$L[5,1], modelb$L[6,1], modelb$L[7,1], modelb$L[8,1], modelb$L[9,1], modelb$L[10,1], modelb$L[11,1], modelb$L[12,1], modelb$L[13,1], modelb$L[14,1], modelb$L[15,1], modelb$L[16,1], modelb$L[17,1])
pneumo1$Uclear <- c(modelb$U[2,1], modelb$U[3,1], modelb$U[4,1], modelb$U[5,1], modelb$U[6,1], modelb$U[7,1], modelb$U[8,1], modelb$U[9,1], modelb$U[10,1], modelb$U[11,1], modelb$U[12,1], modelb$U[13,1], modelb$U[14,1], modelb$U[15,1], modelb$U[16,1], modelb$U[17,1])
...
D <- 
  ...
  theme_bw(base_size = 14, base_family = "American Typewriter") +
  scale_y_continuous(breaks=c(0, 10, 20, 30, 40, 50), limits = c(0, 45)) + 
